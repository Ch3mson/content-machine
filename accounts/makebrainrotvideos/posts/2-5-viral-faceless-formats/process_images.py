"""
Render all 7 slides for: 5 Faceless Video Formats That Work
...
SLIDES = [
    {
        ...
        "role": "hook",
        "header": None,
        "body": "How I never run out of\nfaceless content ideas.",
        "overlay_pct": 0.65,
    },
    {
        "id": 2,
        "role": "step",
        "header": "1. The \"Steal & Spin\" Method",
        "body": "Find the top 3 creators in your niche.\nTake their viral hooks and rewrite\nthem in your own voice.",
        "overlay_pct": 0.75,
    },
    {
        "id": 3,
        "role": "step",
        "header": "2. The \"Opposite\" Framework",
        "body": "Take popular advice and violently\ndisagree with it. Controversy drives\nengagement and endless comments.",
        "overlay_pct": 0.75,
    },
    {
        "id": 4,
        "role": "step",
        "header": "3. Document, Don't Create",
        "body": "Stop trying to invent genius concepts.\nJust post about the mistakes you made\nor things you learned this week.",
        "overlay_pct": 0.75,
    },
    {
        "id": 5,
        "role": "step",
        "header": "4. The \"Cheat Sheet\" Format",
        "body": "People love saving lists.\nJust do a brain dump of the 5 apps or\nresources you use every single day.",
        "overlay_pct": 0.75,
    },
    {
        "id": 6,
        "role": "step",
        "header": "5. Spin 1 Idea into 5 Videos",
        "body": "Never post a good idea just once.\nChange the hook, swap the video,\nand test it 5 different ways.",
        "overlay_pct": 0.75,
    },
    {
        "id": 7,
        "role": "cta",
        "header": None,
        "body": "The tool I use to mass-produce all\nmy variations instantly:",
