"""
Render all 7 slides for: The "Ugly" Content Strategy
...
SLIDES = [
    {
        ...
        "role": "hook",
        "header": None,
        "body": "Stop trying to make\nyour videos look perfect.",
        "overlay_pct": 0.65,
    },
    {
        "id": 2,
        "role": "step",
        "header": "1. Polish Kills Reach",
        "body": "Hyper-edited, flashy videos actually\nget swiped away because\nthey instantly look like ads.",
        "overlay_pct": 0.75,
    },
    {
        "id": 3,
        "role": "step",
        "header": "2. Go \"Ugly\"",
        "body": "Raw, native-looking content performs better.\nIt feels organic and builds\nimmediate trust with the viewer.",
        "overlay_pct": 0.75,
    },
    {
        "id": 4,
        "role": "step",
        "header": "3. Focus on the Hook",
        "body": "Nobody cares about your transitions.\nIf your hook is weak, they will\nscroll past your masterpiece.",
        "overlay_pct": 0.75,
    },
    {
        "id": 5,
        "role": "step",
        "header": "4. Fast > Perfect",
        "body": "The goal isn't to win an Oscar.\nThe goal is to test as many ideas as\npossible as fast as possible.",
        "overlay_pct": 0.75,
    },
    {
        "id": 6,
        "role": "step",
        "header": "5. The 10-Minute Rule",
        "body": "If a video takes you more than\n10 minutes to make, your workflow\nis broken. Automate it.",
        "overlay_pct": 0.75,
    },
    {
        "id": 7,
        "role": "cta",
        "header": None,
        "body": "The tool I use to generate\nnative-looking videos in 30 seconds:",
