"""
Render all 6 slides for: How I make $3K/month posting AI videos
...
Rendering reference: accounts/athlete-stories/Lebron/process_images.py
"""
...
SLIDES = [
    {
        ...
        "role": "hook",
        "header": None,
        "body": "I went from $0 to $3K/month\nposting AI videos.\nHere are the 4 steps\nthat actually work.",
        "overlay_pct": 0.65,
    },
    {
        "id": 2,
        "role": "step",
        "header": "1. Pick a trending niche",
        "body": "Don't just post random content.\nFind niches that are already going\nviral \u2014 motivation, finance, fitness.\nThe algorithm rewards content\npeople are already searching for.",
        "overlay_pct": 0.70,
    },
    {
        "id": 3,
        "role": "step",
        "header": "2. Mass generate 50+ videos",
        "body": "One video won't go viral.\nYou need volume. Generate dozens\nof variations and let the algorithm\ndecide which ones hit.\nMost creators quit after 3 videos.",
        "overlay_pct": 0.70,
    },
    {
        "id": 4,
        "role": "step",
        "header": "3. Post 5-10x per day",
        "body": "The creators making real money\naren't posting once a day.\nThey're flooding the algorithm\nacross multiple accounts.\nMore posts = more chances to go viral.",
        "overlay_pct": 0.70,
    },
    {
        "id": 5,
        "role": "step",
        "header": "4. Monetize with affiliate links",
        "body": "Once you're getting views, put\naffiliate links in your bio.\nEvery viral video becomes\na money printer. One good video\ncan pay for months.",
        "overlay_pct": 0.70,
    },
    {
        "id": 6,
        "role": "cta",
        "header": None,
        "body": "The tool I use to generate\nall my videos:",
...
def make_dark_bg() -> Image.Image:
    """Solid dark background for CTA slide."""
...
def draw_text_block(
    ...
    Uses the athlete-stories technique: draw black outline pixels in a circle,
    then white text on top.
    """
    lines = text.split("\n")
    ...
    for line in lines:
        ...
        # Clamp to margin (Michael Jordan technique)
        if x < MARGIN_X:
            x = MARGIN_X
...
def calc_text_height(text: str, font: ImageFont.FreeTypeFont) -> int:
    ...
    return total - LINE_SPACING  # No spacing after last line
