"""
Render all 7 slides for: Stuck at 200 views (Volume strategy)
...
SLIDES = [
    {
        ...
        "role": "hook",
        "header": None,
        "body": "Why your faceless channel\nis stuck at 200 views.",
        "overlay_pct": 0.65,
    },
    {
        "id": 2,
        "role": "step",
        "header": "1. The Algorithm Doesn't Hate You",
        "body": "You just aren't posting enough.\nOne video a day is\nno longer enough to win.",
        "overlay_pct": 0.75,
    },
    {
        "id": 3,
        "role": "step",
        "header": "2. Do The Math",
        "body": "1 video a day = 30 chances.\n5 videos a day = 150 chances.\nVolume is the ultimate algorithm hack.",
        "overlay_pct": 0.75,
    },
    {
        "id": 4,
        "role": "step",
        "header": "3. Stop Hand-Editing",
        "body": "If you spend 3 hours in CapCut,\nyou have already lost.\nSpeed beats perfection every time.",
        "overlay_pct": 0.75,
    },
    {
        "id": 5,
        "role": "step",
        "header": "4. Test 5 Hooks Daily",
        "body": "Never guess what the audience wants.\nMass-produce 5 variations of an idea\nand let the algorithm decide.",
        "overlay_pct": 0.75,
    },
    {
        "id": 6,
        "role": "step",
        "header": "5. Double Down",
        "body": "Keep the videos that pop.\nDelete the ones that flop.\nRepeat until you hit 1M views.",
        "overlay_pct": 0.75,
    },
    {
        "id": 7,
        "role": "cta",
        "header": None,
        "body": "The tool I use to mass-produce\n5 videos a day effortlessly:",
