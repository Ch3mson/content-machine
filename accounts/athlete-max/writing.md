...
- **Rhythm:** Short punchy hook → problem naming → mechanism explanation → numbered fix → source citation
...
`presets.md` is supplemental. It can define repeatable hooks, flows, or angle
structures only after this baseline writing system and `design.md` pass the
quality gate.
