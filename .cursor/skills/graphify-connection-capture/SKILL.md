...
metadata:
  repo_skill: references/skills/graphify-connection-capture/SKILL.md
---
...
```text
references/skills/graphify-connection-capture/SKILL.md
```
...
This skill saves user-visible connection summaries, not private chain-of-thought.
