...
from _compat import (
    _IS_WIN, _get_port, _store_port, _remove_port,
    SOCK_PATH, LOG_PATH, PID_PATH, try_connect_daemon, make_client_socket,
)
...
def log(msg):
    open(LOG, "a", encoding="utf-8").write(f"{msg}\n")
